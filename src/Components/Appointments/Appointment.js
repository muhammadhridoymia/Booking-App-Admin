...
const Appointments = () => {
  ...
  const filteredAppointments = appointments.filter((appointment) => {
    const matchesSearch =
      ...
      (appointment.emergencyContact?.toLowerCase() || "").includes(
        searchTerm.toLowerCase(),
      );
    ...
    const matchesPayment =
      filterPayment === "all" || appointment.paymentStatus === filterPayment;
  ...
  const handleStatusUpdate = async (bookingId, status) => {
    ...
    try {
      const response = await axios.put(
        `${API}/api/booking/status/${bookingId}`,
        { status },
      );
      if (response.succuss) {
        //refress
              ...
              <div key={appointment._id} className="appointment-card">
                ...
                <div className="card-header">
                  ...
                  <div className="id-section">
                    ...
                    <span className="id-value">
                      {appointment.userId?.slice(-8) || "N/A"}
                    </span>
                  </div>
                </div>
                ...
                <div className="card-content">
                  ...
                  <div className="info-column">
                    <div className="info-group">
                      ...
                      <div className="info-value doctor-name">
                    ...
                    <div className="status-group">
                      ...
                      <div className="update-buttons">
                        <button
                          ...
                          disabled={
                            isUpdating || appointment.status === "accepted"
                          }
                        >
                          ✅ Accept
                        </button>
                        <button
                          ...
                          disabled={
                            isUpdating || appointment.status === "completed"
                          }
                        >
                          🎉 Complete
                        </button>
                        <button
                          ...
                          onClick={() =>
                            handleStatusUpdate(appointment._id, "in-progress")
                          }
                          disabled={
                            isUpdating || appointment.status === "in-progress"
                          }
                        >
                          ⚡ In Progress
                        </button>
                        <button
                          ...
                          disabled={
                            isUpdating || appointment.status === "cancelled"
                          }
                        >
                          ❌ Cancel
                        </button>
                        <button
                          ...
                          disabled={
                            isUpdating || appointment.status === "no-show"
                          }
                        >
                          👤❌ No Show
                        </button>
                    ...
                    <div className="status-group">
                      ...
                      <div className="update-buttons small">
                        <button
                          ...
                          onClick={() =>
                            handlePaymentUpdate(appointment._id, "paid")
                          }
                          disabled={
                            isUpdating || appointment.paymentStatus === "paid"
                          }
                        >
                          ✅ Paid
                        </button>
                        <button
                          ...
                          onClick={() =>
                            handlePaymentUpdate(appointment._id, "pending")
                          }
                          disabled={
                            isUpdating ||
                        ...
                        <button
                          ...
                          onClick={() =>
                            handlePaymentUpdate(appointment._id, "failed")
                          }
                          disabled={
                            isUpdating || appointment.paymentStatus === "failed"
                          }
                        >
                          ❌ Failed
                        </button>
                        <button
                          ...
                          onClick={() =>
                            handlePaymentUpdate(appointment._id, "refunded")
                          }
                          disabled={
                            isUpdating ||
                ...
                <div className="timestamps">
                  <span>
                    Created:{" "}
                    {new Date(
                      appointment.createdAt?.$date || appointment.createdAt,
                    ).toLocaleString()}
                  </span>
                  <span>
                    Updated:{" "}
                    {new Date(
                      appointment.updatedAt?.$date || appointment.updatedAt,
                    ).toLocaleString()}
                  </span>
                </div>
